...
B = [B;[  2    4.6  5.8  4.3  5.5 -3.0  3.0  0.7  1.1  160  190]]; % tWW
...
B = [B;[ 11    5.5  7.0 -3.5 -1.8 -3.0  3.0 -1.1 -0.7  240  -80]]; % cSs  CLZ 2007-12-17
...
B = [B;[ -9    4.3  6.3 -5.1 -3.1 -3.0  3.0  0.7  1.1    0   60]]; % cis S-H - Jesse 10_11_07
...
B = [B;[  6   -0.7  1.3  7.8  9.0 -3.0  3.0  0.65 1.1  -75  -45]]; % tr  WC-S  Exchanged with 6.1 CLZ 12-14-2007
