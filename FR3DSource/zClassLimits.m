...
CurrentVersion = 6.6;                       % version number of class limits
...
B = [B;[ 28 -6.0  4.0 -2.0  4.0 -5.5 5.5 -0.6 0.6   -90  270]]; % perpendicular
...
B = [B;[  9.5 -4.5 -2.5  6.0  8.5 -3.0  3.0  0.6  1.1  -80    0]]; % cis H-S CLZ 2010-04-29
...
B = [B;[  4.5 -0.4  7.0  9.1 11.9 -3.0  3.0 -1.1 -0.7  135  170]]; % tr  H-WC
...
M = [];
for c = 1:16,
  L(c) = sum(ClassLimits(:,1,c) ~= 0);
  M(c) = sum((abs(ClassLimits(:,1,c) < 14)) .* (ClassLimits(:,1,c) ~= 0));
end
