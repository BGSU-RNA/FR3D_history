...
Verbose = 0;                      % tell xFR3DSearch to give information about progress
...
for dd = 1:length(Edges),       % first pairwise interaction
 for ee = 2:length(Edges),      % second pairwise interaction
  for ii = 1:4,                      % code of first letter in the triple
   for jj = 4:4,                     % code of second letter in the triple
    for kk = 4:4,                    % code of third letter in the triple
