...
%  h
  ...
  if (strcmp(a1,'H2*')==1) | (strcmp(a2,'H2*')==1) | ...
     (strcmp(a3,'H2*')==1) | (strcmp(a4,'H2*')==1) | ...
     ((strcmp(a2,'H3')==1) & (C1==2)) | ((strcmp(a3,'H3')==1) & (C2==2)),
     fprintf('Cannot check hydrogen bond for H2* or H3 on C\n');
%    [x{r,1} ' ' x{r,2} ' ' x{r,3} ' ' a1 a2 a3 a4]
  else
