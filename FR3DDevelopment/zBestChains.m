% zBestChains(File) determines the chain or chains in File that has the "best" 3D structure according to some criteria

% function [] = zBestChains(File,Verbose,fid)
